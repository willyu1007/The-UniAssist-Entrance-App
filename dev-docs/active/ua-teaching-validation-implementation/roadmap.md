# Teaching Validation Implementation — Roadmap
...
- Scenario baseline: `dev-docs/active/ua-teaching-assessment-scenario-design/02-architecture.md`
...
- Canonical node chain: `parse_materials -> generate_assessment -> teacher_review -> fanout_delivery -> finish`
